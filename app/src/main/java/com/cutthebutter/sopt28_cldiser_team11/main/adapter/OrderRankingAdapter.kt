...
class OrderRankingAdapter: RecyclerView.Adapter<OrderRankingAdapter.OrderRankingViewHolder>() {
   ...
   // val orderRankingList = mutableListOf<OrderRankingData>()
    val orderRankingList = mutableListOf<ResponseRecentRestaurant.RecentRestaurantData>()
    ...
    class OrderRankingViewHolder(
        ...
        fun onBind(orderRankingData: ResponseRecentRestaurant.RecentRestaurantData){
//            Glide.with(itemView)
//                .load(orderRankingData.ranking_img).placeholder(R.drawable.ranking_img_1).into(binding.rankingImg)
            binding.rankingTitle.text = orderRankingData.title
            binding.starPoint.text = orderRankingData.star
            binding.gradeAmount.text = orderRankingData.reviewCount
